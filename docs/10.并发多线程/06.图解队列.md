...
- LinkedBlockingQueue类 - 由链表构成的有界阻塞队列，界限默认大小为Integer.MAX_Value（21亿），值非常大，相当于无界。
...
## 十三、ConcurrentLinkedDeque

## 十四、ArrayBlockingQueue

## 十五、LinkedBlockingQueue 

## 十六、LinkedBlockingDeque 

## 十七、LinkedTransferQueue 
